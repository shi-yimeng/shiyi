        ...
        <div class="about-card">
          ...
          <section class="about-section">
            ...
            <div class="section-body">
              <p>
                你好，我是
                <strong>师忆（Shiyi）</strong>，一名热爱编程的全栈开发工程师。
              </p>
              <p>
                坐标浙江杭州，主要兴趣和精力都投在了探索 Web
                开发的方方面面：Java、Spring Boot、Vue 3、
                云原生部署、数据库优化，都是我折腾的方向。
              </p>
            </div>
          </section>
          ...
          <section class="about-section">
            ...
            <div class="section-body">
              ...
              <p>
                感谢你的到访。这里没什么特别，只是一名全栈工程师记录成长、思考和生活的地方。欢迎常来坐坐。
              </p>
            </div>
          </section>
          ...
          <section class="about-section">
            ...
            <div class="contact-list">
              <div v-if="info.qq" class="contact-item">
                <span class="contact-label">QQ</span>
                <span class="contact-value">{{ info.qq }}</span>
              </div>
